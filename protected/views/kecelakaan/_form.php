...
<div class="clearfix"></div>
  ...
  <div class="form-group">
    ...
    <div clas="col-sm-9">
      <!-- coba-cba implementasi kodin pak safaaat  -->
      <?php 
  if(!$model->isNewRecord){
    echo '<img style="max-width:100px; max-height:100px;" src="'.Yii::app()->request->baseUrl.'/images/'.$model->foto.'"></img>';
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
    <?php echo $form->textArea($model,'detail',array('class'=>'form-control', 'placeholder'=>'Detail','size'=>255,'maxlength'=>255)); ?>
   </div>
  ...
  <div class="clearfix"></div>
    ...
    <div class="col-sm-9">
    <?php echo $form->textField($model,'deskripsi',array('class'=>'form-control', 'placeholder'=>'Deskripsi','size'=>50,'maxlength'=>50)); ?>
    </div>
  ...
  <div class="clearfix"></div>
    ...
    <div class="col-sm-9">
    <?php echo $form->numberField($model,'id_kategori',array('class'=>'form-control', 'placeholder'=>'Kategori','size'=>50,'maxlength'=>50)); ?>
    </div>
