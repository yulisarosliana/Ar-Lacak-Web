...
<h2><i class="fa fa-truck"></i> Lihat <?php echo $judul ?> #<?php echo $model->id_kecelekaan; ?></h2>
<div class="x_title">
                    </div>
                ...
                <div class="profile_img">
                       ...
                       <a title="Lihat lokasi dari google maps" class="btn btn-success col-md-12" target="_blank" 
                        ...
                        <!--Telegram Share button Start-->
                                            <a title="Share ke Telegram" class="btn btn-info col-md-12" href="https://telegram.me/share/url?url=<?php echo"--ARLacakReport-- Telah terjadi '$model->detail' pada '$model->waktu_pelaporan' di '$model->lokasi', harap tindak lanjuti! Lokasi : "; echo 'http://maps.google.com/maps?q='; echo $model->lat; echo ','; echo $model->lng; ?>" target="_blank"><img src='<?php echo Yii::app()->request->baseUrl; ?>/custom/production/images/telegram.png' style='height:22px; width:22px;'/> Share ke Telegram</a>
                                            <!--Telegram Share Button End-->

                        <!--Whatsapp Share button Start-->
                                            <a title="Share ke WhatsApp" class="btn btn-success col-md-12" href='https://web.whatsapp.com://send?text= <?php echo"--ARLacakReport-- Telah terjadi $model->detail pada $model->waktu_pelaporan di $model->lokasi, harap tindak lanjuti! Lokasi : https://www.google.com/maps/search/$model->lat,$model->lng"; ?>' target="_blank"><img src='<?php echo Yii::app()->request->baseUrl; ?>/custom/production/images/whatsapp.png' style='height:26px; width:26px;'/> Share ke WhatsApp</a>
                                        ...
                                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                            <div class="panel-body">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <th scope="row">Uraian Singkat</th>
